...
8. Celsium\Farenheit display mode affects only hardware display and debug console values on device. I don't know is there Apple bug or mine one, but I can't achieve stable toggling temperature units in Homekit app, it just "freezes" for 1-2 minutes, probably due to large difference between consequental values. To be continued.
